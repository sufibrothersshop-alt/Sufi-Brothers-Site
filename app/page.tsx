...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <header className="border-b border-border bg-background/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="tel:03447575657" className="hidden rounded-xl bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground shadow-md shadow-primary/20 transition hover:brightness-110 sm:block">Order now</a>
      ...
      <section id="deals" className="mx-auto max-w-7xl px-5 py-8 lg:px-8"><div className="relative overflow-hidden rounded-[2rem] bg-primary px-7 py-10 text-primary-foreground sm:px-12"><div className="relative z-10 max-w-md"><p className="text-sm font-bold uppercase tracking-[0.18em] text-primary-foreground/70">Sufi Brothers special</p><h2 className="mt-3 font-serif text-4xl font-black leading-tight sm:text-5xl">More bite.<br />Less price.</h2><p className="mt-4 text-sm leading-6 text-primary-foreground/80">Bring your people, pick your favourites and make it a meal to remember.</p><a href="tel:03447575657" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-secondary px-5 py-3 text-sm font-black text-secondary-foreground">Call to order <ArrowRight className="size-4" /></a></div><div className="absolute -right-16 -top-24 size-80 rounded-full border-[28px] border-primary-foreground/10" /><div className="absolute bottom-[-70px] right-8 hidden w-80 rotate-[-8deg] overflow-hidden rounded-3xl border-8 border-primary-foreground/20 shadow-2xl md:block"><img src="/deals/deal-4.png" alt="Sufi Brothers combo deal" className="h-56 w-full object-cover" /></div></div></section>
