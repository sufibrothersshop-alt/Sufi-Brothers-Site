...
export const menuItems: MenuItem[] = [
  ...
  { id: 12, category: 'Burgers', name: 'Chicken Lapeta Burger', subtitle: 'چکن لپیٹا برگر', price: 350, image: '/Burgers/chicken-lapeta-burger.png' },
  { id: 63, category: 'Burgers', name: 'Chicken Cheese Lapeta Burger', subtitle: 'چکن چیز لپیٹا برگر', price: 400, image: '/Burgers/chicken-cheeze-lapeta-burger.png' },
